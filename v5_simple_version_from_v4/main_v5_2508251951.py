...
#             for file_type, file_info in saved_files.items():
...
#                         # 통합 대화 오디오
#                         if 'merged' in file_info and os.path.exists(file_info['merged']):
...
#                             if role in file_info and os.path.exists(file_info[role]):
